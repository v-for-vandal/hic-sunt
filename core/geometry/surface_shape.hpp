...
public:
    ...
    SurfaceShape(const HexagonSurface& hexagon):
        data_(hexagon) {}

    SurfaceShape(const RhombusSurface& rhombus):
        data_(rhombus) {}
...
private:
    friend SurfaceShape<geometry::QRSCoordinateSystem> ParseFrom(const proto::geometry::SurfaceShape& source, serialize::To<SurfaceShape<geometry::QRSCoordinateSystem>>);
    friend void SerializeTo(const SurfaceShape<geometry::QRSCoordinateSystem>& source, proto::geometry::SurfaceShape& target);
private:
