...
class ControlObject {
  public:
    ...
    ControlObject(const ControlObject& other):
    ...
    static ControlObjectPtr Create() {
      return ControlObjectPtr{};
    }

  private:
    friend void SerializeTo(const ControlObject& source, proto::types::ControlObject& target);
    friend ControlObject ParseFrom(const proto::types::ControlObject& world, serialize::To<ControlObject>);
