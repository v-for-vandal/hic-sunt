...
public:
  ...
  bool AddNumericValue(const StringId& variable, const StringId& key, double value);
  bool MultNumericValue(const StringId& variable, const StringId& key, double value);
