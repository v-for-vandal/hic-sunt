...
func generate_shape(plane: PlaneObject, params: ShapeParameters) -> void:
	pass 
	
class HeightmapParameters:
	var height : int = 10

func generate_heightmap(plane: PlaneObject, params: HeightmapParameters) -> void:
	pass
...
func generate_climate(plane: PlaneObject, params: HeightmapParameters) -> void:
	pass
