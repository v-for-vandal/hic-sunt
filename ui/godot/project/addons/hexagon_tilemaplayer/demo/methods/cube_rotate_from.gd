...
func _on_tile_changed() -> void:
	...
	label.append_text("[color=C45C6D]var[/color] cell = [color=57B2FF]cube_rotate_from[/color](\n")
	...
	for i in 6:
		cells.append(demo.tile_map.cube_rotate_from(demo.tile_map.hovering_tile, from, i))
