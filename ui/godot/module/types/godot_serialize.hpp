...
inline void SerializeTo(const ::godot::StringName& source,
...
// into protobuf. For general conversion to std::string see
// ui/godot/module/utils/to_string.hpp
inline void SerializeTo(const ::godot::String& source,
                        std::string& target) noexcept {
...
// into protobuf. For general conversion to std::string see
// ui/godot/module/utils/to_string.hpp
inline ::godot::StringName ParseFrom(
    const std::string& source, serialize::To<::godot::StringName>) noexcept {
...
// into protobuf. For general conversion to std::string see
// ui/godot/module/utils/to_string.hpp
inline ::godot::String ParseFrom(const std::string& source,
                                 serialize::To<::godot::String>) noexcept {
